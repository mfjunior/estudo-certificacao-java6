...
public class ConfigParamsTest {
	...
	Map<String, String> lookupMap(String paramType) {
		return (map.subMap(paramType, new String("" + (char)(paramType.charAt(0)+1))));
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Shows lookups in ConcurrentSkipListMap is faster than HashTable");
		...
		System.out.println("ConcurrentSkipListMap is " + (double)elapsedTime2/(double)elapsedTime1 +" times faster than HashTable");
